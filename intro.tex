...
Specifically, we elaborate on snoopy (or snooping) techniques~\cite{tang:csdittcms,goodman:ucmtrpt,katz:iaccp,em:dragon,thacker:firefly}, the most commonly used for maintaining processor cache coherency, as an example to illustrate how cache maintenance algorithms are designed (\autoref{sec:algo}).
We also talk about directory-based techniques that are applied in large-scale real-world systems because of their great scalability (\autoref{sec:practical}).